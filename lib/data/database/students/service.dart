...
class StudentDBService implements StudentDBAbstractProvider {
  ...
  Future<void> deleteStudent(Student student) =>
      instance.deleteStudent(student);


  @override
  Future<List<Student>> getAllStudents(SortBy how, Class whichClass) =>
      instance.getAllStudents(how, whichClass);
  ...
  Future<List<Map<String, dynamic>>> getStudentAttendanceMapList(
          Student student) =>
      instance.getStudentAttendanceMapList(student);


  @override
  Future<bool> isPresentToday(Student student) =>
      instance.isPresentToday(student);
  ...
  @override
  Future<void> refresh(Class forWhichClass) => instance.refresh(forWhichClass);
